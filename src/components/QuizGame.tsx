  ...
  if (shuffledQuestions.length === 0) {
    return (
      <div className="max-w-lg mx-auto px-4 py-8 text-center">
        ...
        <Link href={backHref} className="mt-4 inline-block text-sm text-blue-600 dark:text-blue-400">← Back</Link>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-6">
      ...
      <div className="flex items-center gap-3 mb-6">
        <Link href={backHref} className="text-sm text-blue-600 dark:text-blue-400 shrink-0">← Back</Link>
      ...
      {/* Explanation */}
      {showExplanation && (
        <div className={`card p-4 mb-4 ${answerState === 'correct' ? 'bg-green-50 dark:bg-green-950 border-green-200 dark:border-green-900' : 'bg-red-50 dark:bg-red-950 border-red-200 dark:border-red-900'}`}>
