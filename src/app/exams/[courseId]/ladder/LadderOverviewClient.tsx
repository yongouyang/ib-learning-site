...
import { LADDER_LEVELS, LADDER_UNLOCK_SCORE, isLevelUnlocked } from '@/lib/ladder';
            ...
            <>
              ...
              <span className="flex-1">
                ...
                <span className="block text-xs text-gray-500 dark:text-gray-400">
                  {unlocked ? mix : `Score ≥${Math.round(LADDER_UNLOCK_SCORE * 100)}% on Level ${level.level - 1} to unlock`}
                </span>
              </span>
              {result && (
