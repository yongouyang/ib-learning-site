...
import math_dp_aa_sequences_series_json from './data/topics/math/math-dp-aa-sequences-series.json';
import math_dp_aa_exponents_logs_json from './data/topics/math/math-dp-aa-exponents-logs.json';
import math_dp_aa_binomial_theorem_json from './data/topics/math/math-dp-aa-binomial-theorem.json';
import math_dp_aa_functions_json from './data/topics/math/math-dp-aa-functions.json';
import math_dp_aa_quadratics_json from './data/topics/math/math-dp-aa-quadratics.json';
import math_dp_aa_trig_identities_equations_json from './data/topics/math/math-dp-aa-trig-identities-equations.json';
import math_dp_aa_vectors_json from './data/topics/math/math-dp-aa-vectors.json';
import math_dp_aa_descriptive_statistics_json from './data/topics/math/math-dp-aa-descriptive-statistics.json';
import math_dp_aa_probability_json from './data/topics/math/math-dp-aa-probability.json';
import math_dp_aa_distributions_json from './data/topics/math/math-dp-aa-distributions.json';
import math_dp_aa_differentiation_json from './data/topics/math/math-dp-aa-differentiation.json';
import math_dp_aa_integration_json from './data/topics/math/math-dp-aa-integration.json';
...
const math_dp_aa_sequences_series: Topic = topicSchema.parse(math_dp_aa_sequences_series_json);
const math_dp_aa_exponents_logs: Topic = topicSchema.parse(math_dp_aa_exponents_logs_json);
const math_dp_aa_binomial_theorem: Topic = topicSchema.parse(math_dp_aa_binomial_theorem_json);
const math_dp_aa_functions: Topic = topicSchema.parse(math_dp_aa_functions_json);
const math_dp_aa_quadratics: Topic = topicSchema.parse(math_dp_aa_quadratics_json);
const math_dp_aa_trig_identities_equations: Topic = topicSchema.parse(math_dp_aa_trig_identities_equations_json);
const math_dp_aa_vectors: Topic = topicSchema.parse(math_dp_aa_vectors_json);
const math_dp_aa_descriptive_statistics: Topic = topicSchema.parse(math_dp_aa_descriptive_statistics_json);
const math_dp_aa_probability: Topic = topicSchema.parse(math_dp_aa_probability_json);
const math_dp_aa_distributions: Topic = topicSchema.parse(math_dp_aa_distributions_json);
const math_dp_aa_differentiation: Topic = topicSchema.parse(math_dp_aa_differentiation_json);
const math_dp_aa_integration: Topic = topicSchema.parse(math_dp_aa_integration_json);
