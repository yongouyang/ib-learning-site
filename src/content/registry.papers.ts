...
// math-dp-aa practice sets
import math_dp_aa_math_dp_aa_set_1_json from './data/papers/math-dp-aa/math-dp-aa-set-1.json';
import math_dp_aa_math_dp_aa_set_2_json from './data/papers/math-dp-aa/math-dp-aa-set-2.json';
...
const math_dp_aa_math_dp_aa_set_1: Paper = paperSchema.parse(math_dp_aa_math_dp_aa_set_1_json);
const math_dp_aa_math_dp_aa_set_2: Paper = paperSchema.parse(math_dp_aa_math_dp_aa_set_2_json);
