...
import math_igcse_functions_json from './data/topics/math/math-igcse-functions.json';
import math_igcse_angles_polygons_json from './data/topics/math/math-igcse-angles-polygons.json';
import math_igcse_circle_theorems_json from './data/topics/math/math-igcse-circle-theorems.json';
import math_igcse_area_volume_json from './data/topics/math/math-igcse-area-volume.json';
import math_igcse_trigonometry_json from './data/topics/math/math-igcse-trigonometry.json';
import math_igcse_trig_advanced_json from './data/topics/math/math-igcse-trig-advanced.json';
import math_igcse_vectors_json from './data/topics/math/math-igcse-vectors.json';
import math_igcse_statistics_averages_json from './data/topics/math/math-igcse-statistics-averages.json';
import math_igcse_histograms_json from './data/topics/math/math-igcse-histograms.json';
...
const math_igcse_functions: Topic = topicSchema.parse(math_igcse_functions_json);
const math_igcse_angles_polygons: Topic = topicSchema.parse(math_igcse_angles_polygons_json);
const math_igcse_circle_theorems: Topic = topicSchema.parse(math_igcse_circle_theorems_json);
const math_igcse_area_volume: Topic = topicSchema.parse(math_igcse_area_volume_json);
const math_igcse_trigonometry: Topic = topicSchema.parse(math_igcse_trigonometry_json);
const math_igcse_trig_advanced: Topic = topicSchema.parse(math_igcse_trig_advanced_json);
const math_igcse_vectors: Topic = topicSchema.parse(math_igcse_vectors_json);
const math_igcse_statistics_averages: Topic = topicSchema.parse(math_igcse_statistics_averages_json);
const math_igcse_histograms: Topic = topicSchema.parse(math_igcse_histograms_json);
