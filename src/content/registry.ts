...
const biologySubject: Subject = {
  ...
  topics: [bio_body_1, bio_cell_1, bio_classification_1, bio_ecology_1, bio_genetics_1, bio_health_1, bio_human_reproduction_1, bio_microorganisms_1, bio_nutrition_1, bio_photosynthesis_1, bio_plants_1, bio_practical_1, bio_reproduction_1, bio_respiration_1],
};
const chemistrySubject: Subject = {
  ...
  topics: [chem_acids_1, chem_atomic_1, chem_bonding_1, chem_changes_1, chem_earth_1, chem_ion_tests_1, chem_metals_1, chem_mixtures_1, chem_organic_1, chem_periodic_1, chem_rates_1, chem_states_1, chem_working_scientifically_1],
};
const physicsSubject: Subject = {
  ...
  topics: [phys_electricity_1, phys_energy_1, phys_energy_resources_1, phys_forces_1, phys_forces_action_1, phys_light_1, phys_magnetism_1, phys_particles_1, phys_pressure_1, phys_radioactivity_1, phys_simple_machines_1, phys_space_1, phys_waves_1, phys_working_scientifically_1],
};
const geographySubject: Subject = {
  ...
  topics: [geo_yr7_population_urban, geo_yr7_rivers_landforms, geo_yr7_weather_climate_intro, geo_yr7_what_is_geography, geo_yr8_climate_change, geo_yr8_plate_tectonics, geo_yr8_world_climates_biomes, geo_yr9_development, geo_yr9_migration_globalisation, geo_yr9_urbanisation_sustainable_cities],
};
const historySubject: Subject = {
  ...
  topics: [hist_yr7_intro_history_skills, hist_yr7_medieval_china, hist_yr7_medieval_europe, hist_yr8_india_independence_partition, hist_yr8_russian_revolution, hist_yr8_ww1, hist_yr9_holocaust, hist_yr9_nazi_germany, hist_yr9_weimar_nazi_rise, hist_yr9_ww2_asia, hist_yr9_ww2_europe],
};
const ictSubject: Subject = {
  ...
  topics: [ict_yr7_image_editing, ict_yr7_python_basics, ict_yr7_scratch_stem, ict_yr7_spreadsheets, ict_yr7_web_html_css, ict_yr8_3d_design, ict_yr8_animation, ict_yr8_python_next, ict_yr9_microprocessors, ict_yr9_python_projects, ict_yr9_understanding_ai, ict_yr9_video_production],
};
const chineseSubject: Subject = {
  ...
  topics: [chin_yr7_colours_clothes, chin_yr7_family_pets, chin_yr7_food_meals, chin_yr7_greetings_names, chin_yr7_numbers_dates_time, chin_yr7_pinyin_tones_characters, chin_yr8_fairy_tales_fables, chin_yr8_hobbies_daily_routine, chin_yr8_home_rooms, chin_yr8_idioms_chengyu, chin_yr8_school_life, chin_yr8_weather_seasons, chin_yr9_body_health, chin_yr9_culture_inventions, chin_yr9_descriptive_scenery_texts, chin_yr9_festivals_celebrations, chin_yr9_myths_legends, chin_yr9_places_directions, chin_yr9_poetry, chin_yr9_shopping_gifts],
};
const germanSubject: Subject = {
  ...
  topics: [germ_yr7_animals_colours, germ_yr7_family_home, germ_yr7_freetime_hobbies, germ_yr7_greetings_basics, germ_yr7_school_life, germ_yr8_feelings_friendship, germ_yr8_food_drink, germ_yr8_shopping_clothes, germ_yr8_town_directions, germ_yr8_travel_places, germ_yr9_celebrations_health, germ_yr9_housing_rooms, germ_yr9_jobs_professions],
};
