  ...
  flashcards: [
    {
      ...
      definition: 'The number of rows $\times$ columns in a matrix.',
      example: 'A $3 \\times 2$ matrix has $3$ rows and $2$ columns.',
    },
    {
      id: 'math-dp-matrices-f2',
      term: 'Identity matrix $I$',
      definition: 'A square matrix with $1$s on the leading diagonal and $0$s elsewhere.',
      example: 'The $2 \\times 2$ identity is $\\begin{pmatrix} 1 & 0 \\\\ 0 & 1 \\end{pmatrix}$.',
    },
    {
      id: 'math-dp-matrices-f3',
      term: 'Zero matrix $O$',
      definition: 'A matrix where every element is $0$.',
      example: 'The $2 \\times 2$ zero matrix is $\\begin{pmatrix} 0 & 0 \\\\ 0 & 0 \\end{pmatrix}$.',
    },
    {
      ...
      example: '$A$ ($2 \\times 3$) $\times$ $B$ ($3 \\times 4$) is possible and gives a $2 \\times 4$ matrix.',
    },
    {
      id: 'math-dp-matrices-f5',
      term: 'Determinant of a $2 \\times 2$ matrix',
      definition: 'For $\\begin{pmatrix} a & b \\\\ c & d \\end{pmatrix}$, $\\det = ad - bc$.',
      example: '$\\det(\\begin{pmatrix} 3 & 2 \\\\ 1 & 4 \\end{pmatrix}) = 3 \\times 4 - 2 \\times 1 = 10$.',
    },
    {
      id: 'math-dp-matrices-f6',
      term: 'Inverse of a $2 \\times 2$ matrix',
      definition: '$A^{-1} = \\frac{1}{\\det} \\begin{pmatrix} d & -b \\\\ -c & a \\end{pmatrix}$, provided $\\det \\neq 0$.',
      example: 'If $A = \\begin{pmatrix} 4 & 1 \\\\ 3 & 2 \\end{pmatrix}$, $\\det = 5$, so $A^{-1} = \\frac{1}{5} \\begin{pmatrix} 2 & -1 \\\\ -3 & 4 \\end{pmatrix}$.',
    },
    {
      id: 'math-dp-matrices-f7',
      term: 'Singular matrix',
      definition: 'A square matrix with determinant $0$; it has no inverse.',
      example: '$\\begin{pmatrix} 2 & 4 \\\\ 1 & 2 \\end{pmatrix}$ has $\\det = 0$, so it is singular.',
    },
    {
      id: 'math-dp-matrices-f8',
      term: 'Solving $AX = B$',
      definition: 'If $A$ is invertible, the unique solution is $X = A^{-1}B$.',
      example: 'For a system $2x + y = 5$, $x - 3y = 6$, write as $AX = B$ and compute $X = A^{-1}B$.',
    },
  ],
  questions: [
    {
      ...
      choices: ['$3 \\times 4$', '$4 \\times 3$', '12', '7'],
      correctIndex: 1,
      explanation: 'Order is rows $\times$ columns, so $4 \\times 3$.',
    },
    {
      id: 'math-dp-matrices-q2',
      stem: 'Let $A$ be a $2 \\times 3$ matrix and $B$ be a $3 \\times 4$ matrix. What is the order of $AB$?',
      choices: ['$2 \\times 4$', '$3 \\times 3$', '$2 \\times 3$', 'Cannot be multiplied'],
      correctIndex: 0,
      explanation: 'Columns of $A$ ($3$) = rows of $B$ ($3$), so $AB$ exists with order $2 \\times 4$.',
    },
    {
      ...
      correctIndex: 2,
      explanation: 'Matrix multiplication is associative and distributive, but NOT commutative: $AB \\neq BA$ in general.',
    },
    {
      id: 'math-dp-matrices-q4',
      stem: 'Find the determinant of $\\begin{pmatrix} 5 & 2 \\\\ 3 & 4 \\end{pmatrix}$.',
      choices: ['14', '20', '26', '-2'],
      correctIndex: 0,
    ...
    },
    {
      ...
      stem: 'For which value of $k$ is the matrix $\\begin{pmatrix} 2 & 6 \\\\ 1 & k \\end{pmatrix}$ singular?',
      choices: ['2', '3', '4', '6'],
      correctIndex: 1,
      explanation: 'Singular means $\\det = 0$: $2k - 6 = 0 \\rightarrow k = 3$.',
    },
    {
      id: 'math-dp-matrices-q6',
      stem: 'If $A$ is a $2 \\times 2$ matrix with $\\det(A) = 4$, what is $\\det(3A)$?',
      choices: ['12', '36', '24', '4'],
      correctIndex: 1,
      explanation: 'For a $2 \\times 2$ matrix, $\\det(kA) = k^2 \\det(A)$. So $\\det(3A) = 9 \\times 4 = 36$.',
    },
    {
      id: 'math-dp-matrices-q7',
      stem: 'Find the inverse of $\\begin{pmatrix} 2 & 1 \\\\ 5 & 3 \\end{pmatrix}$.',
      choices: ['$\\begin{pmatrix} 3 & -1 \\\\ -5 & 2 \\end{pmatrix}$', '$\\begin{pmatrix} 3 & 1 \\\\ -5 & 2 \\end{pmatrix}$', '$\\begin{pmatrix} 3 & -1 \\\\ 5 & -2 \\end{pmatrix}$', '$\\begin{pmatrix} -3 & 1 \\\\ 5 & -2 \\end{pmatrix}$'],
      correctIndex: 0,
      explanation: '$\\det = 2 \\times 3 - 1 \\times 5 = 1$. $A^{-1} = \\frac{1}{1} \\begin{pmatrix} 3 & -1 \\\\ -5 & 2 \\end{pmatrix} = \\begin{pmatrix} 3 & -1 \\\\ -5 & 2 \\end{pmatrix}$. Swap leading diagonal, negate off-diagonal.',
    },
    {
      ...
      choices: ['1', '2', '3', '4'],
      correctIndex: 1,
      explanation: 'Write as $AX = B$ with $A = \\begin{pmatrix} 2 & 1 \\\\ 3 & 2 \\end{pmatrix}$, $B = \\begin{pmatrix} 7 \\\\ 12 \\end{pmatrix}$. $\\det(A) = 1$, so $A^{-1} = \\begin{pmatrix} 2 & -1 \\\\ -3 & 2 \\end{pmatrix}$. Then $X = A^{-1}B = \\begin{pmatrix} 2 \\\\ 3 \\end{pmatrix}$, giving $x = 2$, $y = 3$.',
    },
    {
      id: 'math-dp-matrices-q9',
      stem: 'If $AB = C$, which equation correctly isolates $B$?',
      choices: ['$B = A^{-1}C$', '$B = CA^{-1}$', '$B = C^{-1}A$', '$B = AC^{-1}$'],
      correctIndex: 0,
      explanation: 'Pre-multiply both sides by $A^{-1}$: $A^{-1}AB = A^{-1}C \\rightarrow IB = A^{-1}C \\rightarrow B = A^{-1}C$.',
    },
    {
      ...
      choices: ['$A$ must be a zero matrix', '$\\det(A)$ must equal $0$', '$A$ must be square and $\\det(A) \\neq 0$', '$B$ must be the identity matrix'],
      correctIndex: 2,
