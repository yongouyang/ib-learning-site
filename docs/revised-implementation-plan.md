...
- Domain cutover spec: `aws-deployment-plan.md` §7 (octavlearning.com registered at CloudFlare, DNS-only CNAMEs, ACM in us-east-1) — **IMPLEMENTED 2026-08-11**: prod serves https://octavlearning.com (www → apex 301) and dev https://dev.octavlearning.com. Corrected 2026-09-19; this line read "not yet implemented".
